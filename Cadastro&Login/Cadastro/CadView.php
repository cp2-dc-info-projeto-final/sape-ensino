      ...
      <div class="col-12 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="CadControl.php">
                ...
                <div class="form-label-group mb-3">
                    ...
                    <input class="form-control" id="matri_cad" name="matri_cad" required="required" type="text" placeholder="ex. 2397523"/>
                  </div>
                </div>
                ...
                <?php 
                    if (isset($_GET['url'])) {$url = $_GET['url'];} else {$url = "aluno";}
                
                    if($url != "aluno"){
                        echo '<div class="form-label-group mb-3">
          ...
          <div class="card-body " style="background-color:#e6e6e6">
            ...
            <a class="text-decoration-none" href="../Login/LogView.php"><button class="btn btn-outline-secondary btn-block">Ir para o Login</button></a>
          </div>
        </div>
      </div>
    </div>
