    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary pt-0 pb-0 mb-4">
    	<div class="container">
	        ...
	        <div class="collapse navbar-collapse" id="collapsenavbar">
				...
				<?php
					include('../View/verificacargo.php');
				?>
			</div><!-- fim do collapse -->
	...
	<div class="container border"> <!--conteudo do site-->
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body"><!-- corpo do modal da escola -->
						<form class="form-signin" method="post" action="../Control/cadastrarEscola.php">
		...
		<div class="modal fade" id="ModalTurma" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body"><!-- corpo do modal da escola -->
						<form class="form-signin" method="post" action="../Control/cadastroturma.php">
							<div class="form-label-group mb-3"> 
                    			...
                    			<div class="input-group">
                        			<div class="input-group-pretend">
                          			...
                          			<select class="custom-select" id="escola-turma" name="escola-turma" required="required" placeholder="Selecione uma opção...">
										...
										<?php 
										include('../View/selectescolas.php');
                            			//<option value=" "></option>
                            			//<option value=" "></option>
										//<option value=" "></option>
										?>
		 ...
		 <!-- Erros & Sucessos -->
		 <?php
		 	include('../View/system_message.php');
		 ?>
		...
		<div class="container ml-5"><!-- centralizaçao do conteúdo-->
				...
				<div class="row ml-2"><!--posiciona os cards horizontalmente-->
					 <?php
					 	include('../View/mostrarescolas.php');
					 ?>
				</div> 
